...
public class PetsshopIntegrationTest {
	...
	void testCreate() throws Exception {
		...
		savedAnimal.setId(2L); // id = 2 because 1 value is inserted using data.sql
	...
	void testUpdate() throws Exception {
		...
		Animal savedAnimal = new Animal("Fluffy", "German Shepherd", "Dog", 500, "Male", "Brown", 01/12/12);
		savedAnimal.setId(1L); // id = 1 because we're updating the value inserted using data.sql
	...
	void testRead() throws Exception {
		...
		animal.setId(1L); // wood object to match the one in wood-data.sql
